...
class KeyDialog(private val context: Context,private val mBinding: DialogKeyBinding) {
        ...
        private fun addNumber(number:Int) {
            ...
            if(quantity.contains(".")){
                ...
                mBinding.tvKeyQuantity.text= context.getString(R.string.quantity_decimal,beforeQuantity.replace(",","").toDouble().formatNumber(),afterQuantity)
            }else{
        ...
        private fun setDot(){
            if(!mBinding.tvKeyQuantity.text.contains(".")){
                mBinding.tvKeyQuantity.text = context.getString(R.string.quantity,mBinding.tvKeyQuantity.text,mBinding.tvKeyDot.text)
            }
        }
