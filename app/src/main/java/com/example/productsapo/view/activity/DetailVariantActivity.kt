...
class DetailVariantActivity : AppCompatActivity() , DetailVariantContract {
    ...
    private fun showPrice(){
        ...
        if (variant.taxable){
            ...
            binding.tvDetailInputTax.text = variant.inputVatRate?.toString() + resources.getString(R.string.phantram)
            binding.tvDetailOutputTax.text = variant.outputVatRate?.toString()  + resources.getString(R.string.phantram)
